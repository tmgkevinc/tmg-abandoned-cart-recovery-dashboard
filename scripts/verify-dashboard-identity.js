...
if (!files.appJs.includes("/api/drafts?market=${market}&limit=${pageSize}&offset=${offset}") || !files.appJs.includes("loadDraftMarketPages")) {
  fail("public/app.js must call the high shipping drafts API per market page.");
}
